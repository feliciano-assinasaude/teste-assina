...
from consulta.blueprints.resources.agendamento import AgendamentoResource, AgendamentoGetOneResource
...
def init_app(app):
    ...
    api.add_resource(MedicoResource, f'{BASE_PATH}/medicos/<string:id_espec>', methods=['GET'])
    api.add_resource(AgendamentoGetOneResource, f'{BASE_PATH}/agendamento/<string:id_agendamento>', methods=['GET'])
